...
<div style="border-left: 4px solid #4EC5D4; padding: 10px 16px; background: rgba(78,197,212,0.1); margin-bottom: 20px;">
...
```mermaid
graph TD
    A[Actividad Económica] --> B[Empresa]
    B --> C[Capital]
    B --> D[Trabajo]
    B --> E[Organización]
    F[Sociedad] --> G[Persona Jurídica]
    G --> H[Patrimonio Propio]
    G --> I[Órganos]
    style F fill:#1a3a5c,color:#ffffff
    style G fill:#2d6a8f,color:#ffffff
    style B fill:#4EC5D4,color:#ffffff
```
...
```mermaid
timeline
    title Evolución de las sociedades
    Roma : societas sin personalidad jurídica
    Edad Media : compañías mercantiles
    Revolución Industrial : SA moderna
    1972 : Ley 19.550
    2015 : Ley 26.994 SAU e informales
```
...
graph TD
    ...
    style C fill:#2d6a8f,color:#ffffff
```
...
<div style="border-left: 4px solid #c9a84c; padding: 10px 16px; background: rgba(201,168,76,0.1); margin-bottom: 20px;">
...
graph TD
    A[Sociedad]
    A --> B[Teoria Contractual]
    A --> C[Teoria Institucional]
    A --> D[Teoria del Acto Complejo]
    A --> E[Teoria Organizativa]
    style A fill:#1a3a5c,color:#ffffff
    style B fill:#2d6a8f,color:#ffffff
    style C fill:#2d6a8f,color:#ffffff
    style D fill:#2d6a8f,color:#ffffff
    style E fill:#2d6a8f,color:#ffffff
```
...
graph TD
    A[Regla Historica]
    A --> B[Pluralidad de Socios]
    C[Ley 26.994]
    C --> D[SAU]
    D --> E[Excepcion Legal]
    style A fill:#2d6a8f,color:#ffffff
    style C fill:#1a3a5c,color:#ffffff
    style D fill:#4EC5D4,color:#ffffff
```
...
```mermaid
flowchart TD
    A[Sociedad insolvente]
    A --> B{Hay fraude o abuso?}
    B -->|No| C[Se respeta la personalidad]
    B -->|Si| D[Posible inoponibilidad]
    style B fill:#1a3a5c,color:#ffffff
    style C fill:#2d6a8f,color:#ffffff
    style D fill:#4EC5D4,color:#ffffff
```
